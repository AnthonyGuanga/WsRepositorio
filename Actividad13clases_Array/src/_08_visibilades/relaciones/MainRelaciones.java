...
public class MainRelaciones {
	public static void main(String[] args) {
		...
		p1.setCuentaBancaria(arrayCb1);
		System.out.println(p1.getCuentaBancaria().length);
		//System.out.println(p1.cuentasBancarias[0].iban);
		CuentaBancaria cb1 = new CuentaBancaria();
		cb1.setIban("ES9897");
		p1.getCuentaBancaria()[0] = cb1;
		cb1.setSaldo(5000);
		System.out.println(p1.getCuentaBancaria()[0].getSaldo());
		...
		System.out.println(p1.getCuentaBancaria()[0].getIban());
		System.out.println(p1.getCuentaBancaria()[1].getIban());
		...
		cb2.setIban("PT56");
		p2.setCuentaBancaria(new CuentaBancaria[2]);
		p2.getCuentaBancaria()[0] = cb2;
		
		cb2 = new CuentaBancaria();
		
		p2.getCuentaBancaria()[1] = cb2;
		cb2.setIban("IT89");
		System.out.println(p2.getCuentaBancaria()[1].getIban());
		System.out.println(p2.getCuentaBancaria()[1]);
