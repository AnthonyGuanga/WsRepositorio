...
public class MainObjetosArrays {
	...
	public static void main(String[] args) {
		...
		mostrarPuntuaciones(r2.puntuaciones[2]);
		mostrarPuntuaciones(r3.puntuaciones[2]);
		mostrarPuntuaciones(r4.puntuaciones[2]);

	}
	
	public static void mostrarPuntuaciones(double p) {
